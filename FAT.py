...
zacetki = []
index_prejsne = 0
b = []  # placeholder list da ostane list crke el
i = 0

for x in besedilo:  # da vsako crko posebi v list
    beseda = list(x)
    for y in beseda:
        crke.append(y)
        b.append(i)
...
for x in besedilo:
    i = 0
    for y in reversed(x):
        index_crke = b.index(y)
        if i == 0:
            stevilke.insert(index_crke, -1)
            del stevilke[index_crke + 1]

            b.insert(index_crke, " ")
            del b[index_crke + 1]

        elif stevilke[index_crke] == " ":
            stevilke.insert(index_crke, index_prejsne)
            del stevilke[index_crke + 1]
            b.insert(index_crke, " ")
            del b[index_crke + 1]
            if i == len(x) - 1:
                zacetki.append(index_crke)
        i += 1
        index_prejsne = index_crke

potek = list(zip(stevilke, crke))
print(zacetki)
print(potek)
